                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                className="flex-1 px-4 py-2.5 bg-white dark:bg-[#1e2538] border border-gray-200 dark:border-[#232b3e] rounded-lg text-gray-900 dark:text-[#e8eaf0] focus:outline-none focus:border-[#4f80ff] focus:ring-1 focus:ring-[#4f80ff] transition-colors dark:[color-scheme:dark]"
                            />
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-2.5 pr-12 bg-white dark:bg-[#1e2538] border border-gray-200 dark:border-[#232b3e] rounded-lg text-gray-900 dark:text-[#e8eaf0] placeholder:text-gray-400 dark:placeholder:text-[#5a5f73] focus:outline-none focus:border-[#4f80ff] focus:ring-1 focus:ring-[#4f80ff] transition-colors"
                            />
